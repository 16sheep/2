Feature: Reject new version of T&C (per account)
  ...
  Scenario:
    ...
    Then I should see a message
      """
      repaid data bundles) will stop working, however all device information will still be stored for insurance purposes. This will impact all your connected cars.
      """
    And a ConfirmCTA
    And a CancelCTA
    And a CloseCTA
